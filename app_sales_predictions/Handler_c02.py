...
from rossmann.Rossmann_Prep import Rossmann_Prep # from folder.file import class
...
if __name__ == '__main__':
    ...
    #app.run(host='192.168.0.15', port=find_port, debug=True)